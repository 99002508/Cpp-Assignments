...
AccountBase::AccountBase(){} //Default constructor
...
double CreditAccount::debit(double deb)
{
    m_balance -= deb;
    return m_balance;
}
double SavingsAccount::debit(double deb)
{
    m_balance -= deb;
    return m_balance;
}
double CreditAccount::credit(double cre)
{
    m_balance += cre;
    return m_balance;
}
double SavingsAccount::credit(double cre)
{
    m_balance += cre;
    return m_balance;
}
